//scatter19.cppの点の移動だけ考えれば、scatter24.cppと合体できるかな...？
//cv::Point2f img_point = transform_point(x, y);
//いまclickすると、座標としては画面上の座標が取得される
//この画面上の座標は、画像の座標とは異なる
//画面上の座標を、画像上の座標に変換するのがtransform_point
...
//たぶんそのままでいいところ
//ここでlengthだけ倍率ぶん変えるべきかな？？->変えなくてもいい
//出力される点の座標が変な感じで出てくるかもしれないから逆変換が必要かも->必要ない
//角度はたぶんそのままでいい
///////////////////////////////////////////////////////////////////////////////
...
int main() {
    ...
    //&img_displayにすると、clickの点などが引き継いで更新されない
