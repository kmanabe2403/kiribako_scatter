...
std::string coo;
std::ostringstream psi1_text, psi2_text, psi3_text, theta_text;
...
void at_click(int event, int x, int y, int flags, void* param) {
    if (event == cv::EVENT_LBUTTONDOWN) {  // 左クリック時
        ...
        if (click == 1) {
            ...
            a3 = draw_line(*img, point2, point4_1, x_length, cv::Scalar(100, 100, 255), 1);
            ...
            a3 = draw_line(*img, point2, point4_2, x_length, cv::Scalar(100, 100, 255), 1);
            std::cout << a2 << std::endl;
            std::cout << a3 << std::endl;
            ...
            a3 = draw_line(*img, point2, point4_3, x_length, cv::Scalar(100, 100, 255), 1);
            std::cout << a2 << std::endl;
            std::cout << a3 << std::endl;
            ...
            //＊step5
            draw_rectangle(*img, point2, point2, point2_4, point2_4, point3, cv::Scalar(255,0,0), 1);
...
int main() {
    ...
    name_out << "./png_test/" << name << "_scatter11.png";
