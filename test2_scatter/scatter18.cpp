...
void at_click(int event, int x, int y, int flags, void* param) {
    if (event == cv::EVENT_LBUTTONDOWN) {  // 左クリック時
        ...
        if (click == 1) {
            ...
            cv::putText(*img, psi_text.str(), cv::Point(230, 50+(j+1)*m+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, psi_rms_text.str(), cv::Point(230, 155+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, psi_sigma_text.str(), cv::Point(230, 170+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, theta_0_text.str(), cv::Point(230, 185+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, beta_text.str(), cv::Point(230, 215+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, pb_ele_mc_text.str(), cv::Point(230, 230+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, bpc_text.str(), cv::Point(230, 245+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, beta_text.str(), cv::Point(230, 275+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, pb_ele_mc_text.str(), cv::Point(230, 290+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
            ...
            // cv::putText(*img, bpc_text.str(), cv::Point(230, 305+term*height), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(0,0,255), 1);
