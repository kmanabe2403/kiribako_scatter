...
void at_click(int event, int x, int y, int flags, void* param) {
    if (event == cv::EVENT_LBUTTONDOWN) {  // 左クリック時
        ...
        if (click == 1) {
            ...
            cv::putText(*img, coo, cv::Point(20, 50+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, coo, cv::Point(20, 60+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, coo, cv::Point(20, 70+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            coo =  "2_2: (" + std::to_string(point2_2.x) + ", " + std::to_string(point2_2.y) + ")";   
            cv::putText(*img, coo, cv::Point(20, 80+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            coo =  "2_3: (" + std::to_string(point2_3.x) + ", " + std::to_string(point2_3.y) + ")";   
            cv::putText(*img, coo, cv::Point(20, 90+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            coo =  "2_4: (" + std::to_string(point2_4.x) + ", " + std::to_string(point2_4.y) + ")";   
            cv::putText(*img, coo, cv::Point(20, 100+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, "x  " + std::to_string(x_length), cv::Point(150, 50+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);

            cv::putText(*img, "x cm " + std::to_string(x_cm), cv::Point(150, 60+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, coo, cv::Point(20, 110+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, coo, cv::Point(20, 120+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, psi1_text.str(), cv::Point(150, 70+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, coo, cv::Point(20, 130+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, psi2_text.str(), cv::Point(150, 80+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, coo, cv::Point(20, 140+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, psi3_text.str(), cv::Point(150, 90+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, coo, cv::Point(20, 150+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0, 0, 255), 1.5);
            ...
            cv::putText(*img, theta_text.str(), cv::Point(150, 100+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, psi_rms_text.str(), cv::Point(150, 120+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, psi_sigma_text.str(), cv::Point(150, 130+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, theta_0_text.str(), cv::Point(150, 140+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, beta_text.str(), cv::Point(150, 160+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, pb_ele_mc_text.str(), cv::Point(150, 170+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, bpc_text.str(), cv::Point(150, 180+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, beta_text.str(), cv::Point(150, 200+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, pb_ele_mc_text.str(), cv::Point(150, 210+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
            ...
            cv::putText(*img, bpc_text.str(), cv::Point(150, 220+term*200), cv::FONT_HERSHEY_SIMPLEX, 0.3, cv::Scalar(0,0,255), 1);
...
int main() {
    ...
    name_out << "./png_test/" << name << "_scatter14.png";
